...
import type { SessionDetailProps, LapDot, StreamLocationPoint } from './SessionDetail.types'
        ...
        <div className={styles.playback}>
          <div className={styles.playbackControls}>
            ...
            <button
              className={styles.playBtn}
              aria-label="Restart"
              onClick={() => { setPlaying(false); setPlaybackMs(0) }}
            >
          ...
          <span className={styles.playbackTime}>
            ...
            {String(Math.floor((playbackMs % 60000) / 1000)).padStart(2, '0')} / {session.totalTime ?? '01:12:00'}
          </span>
        </div>
